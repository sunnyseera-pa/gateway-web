...
describe('Given the teams service', () => {
    ...
    describe('When addMembers is called', () => {
        it('Then calls postRequest with the correct arguments', async () => {
            await service.addMembers(123, {
                id: '123',
            });

            expect(postRequest).toHaveBeenCalledWith(`${apiURL}/teams/123/members`, {
                id: '123',
            });
        });
    });
    ...
    describe('When useAddMembers is called', () => {
        it('Then calls addMembers with the correct arguments', async () => {
            const postSpy = jest.spyOn(service, 'addMembers');
            const rendered = renderHook(() =>
                service.useAddMembers('1234', {
                    id: '12344',
                })
            );
            assertServiceMutateAsyncCalled(rendered, postSpy, '1234', { id: '12344' });
        });
    });
