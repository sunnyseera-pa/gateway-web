        ...
        switch (type.toUpperCase()) {
            ...
            case 'SUBMITFORREVIEW':
                config = {
                    ...
                    subTitle: 'Are you sure that you want to submit this version of this dataset for review?\n\nYou cannot edit this form whilst it is pending.',
                    description: false,
                    buttons: {
                        cancel: {
                            label: 'No, nevermind',
            ...
            case 'APPROVE':
                config = {
                    ...
                    subTitle: 'If you made any amendments to their application, such as fixing a typo, please let the editor know using the description below.',
                    description: true,
                    buttons: {
                        cancel: {
                            label: 'No, nevermind',
