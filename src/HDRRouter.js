					...
					<Switch>
						...
						{userState[0].loggedIn ? (
							<Route
								...
								render={props => <DataAccessRequestTranslated {...props} userState={userState} />}
							/>
						) : (
							''
						)}
						...
						{userState[0].loggedIn ? (
							<Route path='/data-access-request/:accessId' render={props => <DataAccessRequestTranslated {...props} userState={userState} />} />
						) : (
							''
						)}
