			...
			<Router>
				...
				<div className='mainWrap' onScroll={this.handleScroll}>
					<Switch>
						...
						<GuardedRoute path='/data-access-request/dataset/:datasetId' component={DataAccessRequestTranslated} userState={userState} />
						<GuardedRoute
							path='/data-access-request/publisher/:publisherId'
							component={DataAccessRequestTranslated}
							userState={userState}
						/>
						<GuardedRoute path='/data-access-request/:accessId' component={DataAccessRequestTranslated} userState={userState} />
