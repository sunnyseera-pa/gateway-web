...
import SearchControlsSort from '.';
...
describe('Given the SearchControlsSort component', () => {
    describe('When it is rendered', () => {
        beforeAll(() => {
            wrapper = render(<SearchControlsSort {...props} />, {
                wrapper: Providers,
            });
        });
        ...
        describe('And it is not loading', () => {
            beforeAll(() => {
                wrapper = render(<SearchControlsSort {...props} isLoading={false} />, {
                    wrapper: Providers,
                });
            });
            ...
            describe('And it does not have sort props', () => {
                it('Then should not show the sort', () => {
                    wrapper = render(<SearchControlsSort {...props} sortProps={null} />, {
                        wrapper: Providers,
                    });
