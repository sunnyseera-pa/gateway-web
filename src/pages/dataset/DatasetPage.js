                      ...
                      <div className="Rectangle">
                          ...
                          <Row className="mt-5">
                            ...
                            <Row className="mt-3">
                                ...
                                {data.conformsTo ? <Col sm={8} lg={8} className="Gray800-14px" style={{ "overflow-wrap": "break-word"}} >{data.conformsTo}</Col> : <Col sm={8} lg={8} className="Gray800-14px-Opacity">Not specified</Col> }
                            </Row>
