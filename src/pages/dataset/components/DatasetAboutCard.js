                            ...
                            <div className='rectangle'>
                                ...
                                {showEmpty === false && isEmpty(v2data.enrichmentAndLinkage.derivation) ? (
                                    ...
                                    <AboutCardElement
                                        ...
                                        tooltip={
                                            'Indicates if derived datasets or predefined extracts are available and the type of derivation available.'
                                        }
                                    />
                                )}
                            </div>
                            ...
                            <div className='rectangle'>
                                ...
                                isEmpty(v2data.summary.publisher.deliveryLeadTime) ? (
                                    ...
                                    <AboutCardElement
                                        ...
                                        tooltip={
                                            'An indication of the typical processing times based on the types of requests typically received.'
                                        }
                                    />
                                )}
                                {showEmpty === false &&
                                ...
                                isEmpty(v2data.summary.publisher.accessRequestCost) ? (
                                    ...
                                    <AboutCardElement
                                        ...
                                        tooltip={
                                            'Indication of cost (in GBP) for processing each data access request by the data custodian.'
                                        }
                                    />
                                )}
                                {showEmpty === false &&
                            ...
                            <div className='rectangle'>
                                ...
                                {showEmpty === false && isEmpty(v2data.enrichmentAndLinkage.tools) ? (
                                    ...
                                    <AboutCardElement
                                        ...
                                        tooltip={
                                            'Any analysis tools or models that have been created for this dataset and are available for further use.'
                                        }
                                    />
                                )}
                            </div>
