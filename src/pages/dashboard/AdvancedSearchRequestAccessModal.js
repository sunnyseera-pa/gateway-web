			...
			<Modal
				...
				<div className='advancedSearchRequestAccessModal-header'>
					<div className='advancedSearchRequestAccessModal-header--wrap'>
						...
						<p>
							In order to protect patient privacy, we need to verify your identity. To gain access to the advanced search tool, please raise
							a support ticket. Please make sure you have filled out enough information on your profile otherwise you may be asked to
							provide more details before being approved. You will receive an email to confirm the approval of your request.
						</p>
					</div>
				</div>
