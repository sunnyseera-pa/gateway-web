        ...
        <Fragment>
          ...
          <Col sm={10} lg={10}>
            <div className="teamRectangle">
                ...
                <p className="gray800-15 mb-8 teamSubtitle">This section provides answers to some of the questions that you may have about workflows, team members and data access request applications.</p>
            {
                help.length > 0 &&
                help.map((h, i) => {
                    return (
