          ...
          <Col sm={10} lg={10}>
            <div className="rectangle">
              ...
              <p className="gray800-15 margin-bottom-6">
                ...
                age, and location. This feature is still being tested, so only a
                limited number of datasets are available for now.
              </p>
            </div>
          </Col>
          <Col sm={1} lg={1} />
                ...
                <Accordion.Collapse eventKey="0">
                  <Card.Body className="datasetCard gray800-14">
                    <ul className="gray800-14">
                      ...
                      <li>
                        Select the characteristics you need for your project ,
                        such as disease, age, gender and location.
                      </li>
                      <li>
                        Use AND/OR to specify your inclusion and exclusion
                        criteria.
                      </li>
                      <li>
                        The tool will give you a list of datasets listed on the
                        Gateway where this data is available, including sample
                        size.
                      </li>
              ...
              >
                ...
                <Accordion.Collapse eventKey="1">
                  <Card.Body className="datasetCard gray800-14">
                    <ul className="gray800-14">
                      <li>
                        Once you have found the datasets you need, you can make
                        a Data Access Request via the Innovation Gateway
                      </li>
                      <li>
                        Search for the datasets on the Innovation Gateway and
                        either make an enquiry or request acccess
                      </li>
                      <li>
                        Data Access Requests must be made individually for each
                        dataset
                      </li>
                    </ul>
                  </Card.Body>
