    ...
    return (
      <div>
          ...
          <Col sm={10} lg={10}>
            <div className="rectangle">
              ...
              <p className="gray800-15 margin-bottom-6">
                ...
                patient data, only information about the datasets (metadata).
                Adding new datasets or managing existing ones can be done via
                the metadata onboarding platform.
              </p>
            </div>
          </Col>
          <Col sm={1} lg={1} />
                ...
                <Accordion.Collapse eventKey="0">
                  <Card.Body className="datasetCard gray800-14">
                    <ul className="gray800-14">
                      ...
                      <li>
                        The more information you add, the easier it will be for
                        applicants to understand if your dataset fits their
                        needs
                      </li>
                      <li>
                      ...
                      <li>
                        All datasets will be reviewed and approved before going
                        live
                      </li>
                    </ul>
                  </Card.Body>
              ...
              >
                ...
                <Accordion.Collapse eventKey="2">
                  <Card.Body className="datasetCard gray800-14">
                    <ul className="gray800-14">
                      <li>
                        The User Guide contains how-to guides, descriptions and
                        examples for each data field
                      </li>
                      <li>
                        If you cannot find the information you need in the User
                        Guide, please submit a ticket using the Service Desk
                      </li>
                      <li>Both can be accessed using the buttons below</li>
                      <li>
                        If you already had an account, you’ll need to be granted
                        access again. If you have any issues, please submit a
        ...
        <ActionBar userState={userState}>
          ...
          <Button
            variant="primary"
            href="https://hdruk-sso.metadata.works"
            target="_blank"
            id="metadataButton"
