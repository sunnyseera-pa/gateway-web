					...
					<Form autoComplete='off'>
						<div className='enquiry-message-form'>
							...
							<div className='form-group gray800-14'>
								...
								/>
								{hasErrors(touched, errors, 'datasetsRequested') ? <div className='errorMessages'>{errors.datasetsRequested}</div> : null}
							</div>
							...
							{values && values['safedata-otherdatasetsintentiontolinkdata'] === 'Yes' ? (
								<div className='form-group gray800-14'>
									...
									<Field
										...
										className={`form-control gray800-14 ${
											hasErrors(touched, errors, 'safedataotherdatasetslinkadditionaldatasetslinkagedetails') ? 'is-invalid' : ''
										}`}
									/>
