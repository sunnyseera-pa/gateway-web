	...
	return (
		<div className='mb-1'>
			<div id='loginButtons'>
				<Row className='mt-2'>
					...
					<Col sm={10} lg={10}>
						<span className='gray800-14'>
							Anyone can search and view datasets, collections and other resources with or without an account. Creating an account allows
							you to:
						</span>
					</Col>
					<Col sm={1} lg={1} />
				...
				<LoginSSOButtons clickHandler={clickHandler} communityLink={communityLink} lastChoice={lastChoice} ssoBtnsConfig={ssoBtnsConfig} />
			</div>
