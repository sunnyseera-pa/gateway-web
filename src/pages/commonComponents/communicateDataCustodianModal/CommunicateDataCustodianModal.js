...
const CommunicateDataCustodianModal = ({open, closed}) => {
  ...
  return (
    ...
    <Modal.Body>If you have not done so yet, we recommend contacting the data custodian and making an enquiry to discuss your requirements. The earlier you get in touch, the better. The data custodian will advise on next steps, will help you understand the data and will provide information on how to complete the data access application form if appropriate.</Modal.Body>
    <Modal.Footer>
