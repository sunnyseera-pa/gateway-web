        ...
        <div className={styles.postRightCol}>
          <div className={styles.postDetails}>
            ...
            <div className={styles.postDate}>
              <span><Moment format="DD MMM YYYY HH:mm">{post.created_at}</Moment></span>
            </div>
          </div>
  ...
  formContent(mode) {
    ...
    <div className={styles.newPostContainer}>
          ...
          value={values.comment}
				...
				<div className={styles.buttonFooter}>
				  <button className="button-tertiary" type="button" onClick={() => onPostCancel(postId)}>Cancel</button>
          <button className="button-primary" type="submit" disabled={isSubmitting}>{submitText}</button>
				</div>
			</form>
			)}
		</Formik>
