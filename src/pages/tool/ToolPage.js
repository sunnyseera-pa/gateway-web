												...
												<div className='rectangle'>
													...
													<Row className='mt-3'>
														<Col sm={12} className='gray800-14'>
															<ReactMarkdown className='wordBreakAll' source={toolData.description} />
														</Col>
													</Row>
												</div>
											</Col>
											...
											<Row className='mt-2'>
												<Col sm={12} lg={12}>
													<div className='rectangle'>
														...
														<Row className='mt-3'>
															<Col sm={12} className='gray800-14'>
																<ReactMarkdown className='wordBreakAll' source={toolData.resultsInsights} />
															</Col>
														</Row>
													</div>
												</Col>
												...
												<div className='rectangle'>
													...
													<Row className='mt-3'>
														...
														<Col sm={10} className='gray800-14'>
															<a href={toolData.link} rel='noopener noreferrer' target='_blank' className='purple-14 wordBreakAll'>
																{toolData.link}
															</a>
														</Col>
													</Row>
