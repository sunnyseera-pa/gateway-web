  ...
  "questionSets": [
      ...
      "questions": [
        {
          ...
          "guidance":
            "Select a role for the individual."
        },
        {
          "questionId": "fullname",
          "question": "Full name",
          ...
          "guidance":
            "All applicants must have an account in the Gateway."
        },
        {
    ...
    },
    {
      ...
      "questions": [
        ...
        },
        {
          ...
          "question": "Can you provide an outline of the public engagement strategy of the study or a brief explanation why there is no public engagement?",
    ...
    },
    {
      ...
      "questions": [
        ...
        {
          "questionId": "describeanydatasetsalreadyheldfortheprojectpleaseincludedatasetnameclassificationofthedatathelegalbasisforprocessingandthedatasetperiod",
          "input": {
            "type": "textareaInput"
          },
          "question": "Describe any datasets already held for the project (please include dataset name, classification of the data, the legal basis for processing and the dataset period)."
        },
        {
      ...
      "questions": [
        {
          ...
          "question": "Please enclose evidence of caldicott guardian or other approved signatory for processing the data for the purpose(s) outlined above.",
          "input": {
            "type": "checkboxOptionsInput",
            "options": [
              {
    ...
    },
    {
      "questions": [
        ...
        {
          "question": "Please enclose all letters documenting that section 251 support has been granted and remains extant, sent to you by data custodian for this project.",
          "input": {
            "options": [
              {
          ...
          "questionId": "pleaseenclosealllettersdocumentingthatsection251supporthasbeengrantedandremainsextantsenttoyoubydatacustodianforthisproject"
        }
      ],
    ...
    },
    {
      ...
      "questions": [
        {
          "questionId": "howlongdoyouintendtoretainidentifiableorpotentiallyidentifiableinformationaftertheconclusionoftheprojectincludingarchivebackupcopies",
          "input": {
            "type": "textareaInput"
          },
          "question": "How long do you intend to retain identifiable or potentially identifiable information after the conclusion of the project (including archive/backup copies)?"
        },
        {
