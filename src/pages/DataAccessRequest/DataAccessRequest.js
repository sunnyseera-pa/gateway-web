...
class DataAccessRequest extends Component {
	...
	onNextClick = () => {
		...
		if (this.state.activePanelId === 'about') {
			...
			if (this.state.activeAccordionCard >= 3) {
				this.setState({
			...
			if (!_.isEmpty(questionAnswers)) {
				...
				fullAmendments = _.reduce(
					...
					(obj, value, key) => {
						...
						// In case of questions dynamically generated by winterfell with an arbitrary suffix on the questionSetId (i.e. another individual)
