    ...
    <div className="files">
      ...
      <div {...getRootProps()}>
        ...
        <div className="upload">
          <button className="button-tertiary"><UploadSVG /> Select files</button>
          <span className="gray700-alt-13">PDF, CSV, TXT, Powerpoint, Word, Excel, Keynote, Pages, Numbers, JPG or PNG.<br /> 
