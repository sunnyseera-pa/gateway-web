...
const UpdateRequestModal = ({ open, close, fullAmendments, publisher, applicationId, projectName ='' }) => {
    ...
    if(!_.isEmpty(applicationId) && !_.isEmpty(publisher)) {
      console.log(`${baseURL}/api/v1/data-access-request/${applicationId}/requestAmendments`);
      debugger;
      axios.post(`${baseURL}/api/v1/data-access-request/${applicationId}/requestAmendments`)
      .then((res) => {
        let alert = {
          publisher,
