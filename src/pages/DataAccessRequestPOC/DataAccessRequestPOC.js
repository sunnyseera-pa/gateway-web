 ...
 class DataAccessRequestPOC extends Component {
    ...
    constructor(props) {
        ...
        this.state ={
            ...
            userState: [{
                loggedIn: props.userState[0].loggedIn,
                role: props.userState[0].role,
                id: props.userState[0].id,
                name: props.userState[0].name
              }],
            searchString: '',
            // showComponent: false
            key: 'guidance'
    ...
    render() {
        const { searchString, datasetTitle, datasetPublisher, userState } = this.state;
