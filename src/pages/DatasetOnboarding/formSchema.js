    ...
    "questionSets": [
        ...
        //Summary start
        {
            ...
            },
            {
                ...
                "validations": [{
                    "type": "isValidDoiName",
                    "message" : "Please select an option 2"
                    //Paul - custom validation needed
                }]
            }]
        }, 
        //Summary end
        ...
        //Documentation start
        {
            ...
            "questions": [{
                ...
                //"text" : "3,000 character limit (0/3,000)",
                "guidance": "- An HTML account of the data that **provides context and scope** of the data, **limited to 3000 characters, and/or a resolvable URL** that describes the dataset.\n- Additional information can be recorded and included using media.",
                "input": {
                    "type": "textareaInput"
                },
                "validations": [{
            ...
            },
            {
                "questionId": "isPartOf",
                "question": "Is part of",
                "guidance": "- Please complete only if the dataset is part of a group or family of datasets i.e. Hospital Episode Statistics has several constituents.\n- If your dataset is not part of a group, please enter “NOT APPLICABLE”\n- **Example**: Hospital Episodes Statistics datasets (A&E, APC, OP, AC MSDS).",
                "input": {
                    "type": "textInput"
                },
                "validations": [{
            ...
            },
            {
                ...
                "input": {
                    ...
                    "options": [{
                        ...
                        "text": "ELECTRONIC SURVEY",
                        "value": "electronicsurvey"
                    },{
                        "text": "LIMS",
                        "value": "lims"
                    },{
        ...
        //Temporal start
        {
            ...
            {
                "questionId": "distributionReleaseDate",
            ...
            "questions": [{
                ...
                "input": {
                    ...
                    "options": [{
                        ...
                        "text": "GENETICS STUDIES ONLY",
                        "value": "geneticsStudiesOnly"
                    }, {
                        "text": "NO GENERAL METHODS RESEARCH",
                        "value": "noGeneralMethodsResearch"
                    }, {
                        "text": "NO RESTRICTION",
                        "value": "noRestriction"
                    }, {
                        "text": "RESEARCH SPECIFIC RESTRICTIONS",
                        "value": "researchSpecificRestrictions"
                    }, {
                        "text": "RESEARCH USE ONLY",
                        "value": "researchUseOnly"
                    }, {
                        "text": "NO LINKAGE",
                        "value": "noLinkage"
                    }]
                ...
                "questionId": "dataUseRequirements",
                ...
                "input": {
                    "type": "checkboxOptionsInput",
                    "options": [{
                        "text": "COLLABORATION REQUIRED",
                        "value": "collaborationRequired"
                    }, {
                        "text": "ETHICS APPROVAL REQUIRED",
                        "value": "ethicsApprovalRequired"
                    }, {
                        "text": "GEOGRAPHICAL RESTRICTIONS",
                        "value": "geographicalRestrictions"
                    }, {
                        "text": "INSTITUTION SPECIFIC RESTRICTIONS",
                        "value": "institutionSpecificRestrictions"
                    }, {
                        "text": "NOT FOR PROFIT USE",
                        "value": "notForProfitUse"
                    }, {
                        "text": "PROJECT SPECIFIC RESTRICTIONS",
                        "value": "projectSpecificRestrictions"
                    }, {
                        "text": "PUBLICATION MORATORIUM",
                        "value": "publicationMoratorium"
                    }, {
                        "text": "PUBLICATION REQUIRED",
                        "value": "publicationRequired"
                    }, {
                        "text": "RETURN TO DATABASE OR RESOURCE",
                        "value": "returnToDatabaseOrResource"
                    }, {
                        "text": "TIME LIMIT ONE USE",
                        "value": "timeLimitOneUse"
                    }, {
                        "text": "USER SPECIFIC RESTRICTION",
                        "value": "userSpecificRestriction"
                    }]
                }
            },{
                "questionId": "resourceCreator",
                ...
                "input": {
                    "type": "textInput"
                    //Paul - custom multi needed - limit of 1000
                }
            },{
                "questionId": "investigations",
        ...
        //Access start
        {
            ...
            "questions": [{
                "questionId": "accessRights",
                "question": "Access rights",
                "text" : "The URL of a webpage(s) where the data access request process and/or guidance is provided.",
                "guidance": "- The URL of a webpage where the data access request process and/or guidance is provided. If there is more than one access process i.e. industry vs academic please provide both.\n- If such a resource or the underlying process doesn’t exist, please provide “In Progress”, until both the process and the documentation are ready.",
                "input": {
                    "type": "textInput"
                    //Paul - custom multi needed - url
                }
            },
            {
                "questionId": "accessService",
                ...
                "guidance": "- Please provide link(s) to a webpage detailing the commercial model for processing data access requests for the organisation (if available).\n- Definition: Indication of commercial model or cost (in GBP) for processing each data access request by the data custodian.",
                "input": {
                    "type": "textInput"
                }
            },{
                "questionId": "deliveryLeadTime",
                ...
                "guidance": "- Please use country code from [ISO 3166-1](https://en.wikipedia.org/wiki/ISO_3166-1) country codes and the associated [ISO 3166-2](https://www.iso.org/standard/63546.html) for regions, cities, states etc. for the country/state under whose laws the data subjects’ data is collected, processed and stored.\n- Multiple Jurisdictions may be provided (if applicable).\n- **Default**: GB-ENG",
                "input": {
                    "type": "textInput"
                    //Paul - custom multi needed - country
                }
            },
            {
                "questionId": "dataController",
        ...
        {
            "questionSetId": "formatAndStandards",
            "questionSetHeader": "Vocabulary encoding scheme",
            "questions": [{
                "questionId": "jurisdiction",
                "question": "Jurisdiction",
                ...
                "input": {
                    "type": "textInput"
                    //Paul - custom multi needed
                }
            },{
                "questionId": "conformsTo",
