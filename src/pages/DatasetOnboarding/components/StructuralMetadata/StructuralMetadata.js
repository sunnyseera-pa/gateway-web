                                        ...
                                        <>
                                            {errors.column === 'Sensitive' ?
                                                errors.error === 'required' ?
                                                    <>Error in row {errors.row}: "{errors.column}" is empty and should be "True" or "False"<br /></> :
                                                    <>Error in row {errors.row}: "{errors.column}" is "{errors.value}" and should be "True" or "False"<br /></>
                                                : <>Error in row {errors.row}: "{errors.column}" is empty and is required<br /></>}
                                        </>
                                    );
                                })}
                            </Alert>
                        ...
                        {structuralMetadata.map((data, index) => {
                            ...
                            return (
                                <tr className='gray800-14'>
                                    ...
                                    <td className={_.some(filtered, ['column', 'Data Type']) ? 'invalid-info table-cell' : 'table-cell'}>
                                        {data.dataType}
                                    </td>
                                    <td className={_.some(filtered, ['column', 'Sensitive']) ? 'invalid-info table-cell' : 'table-cell'}>
                                        {_.some(filtered, ['column', 'Sensitive']) ?
                                            _.find(filtered, ['column', 'Sensitive']).value :
