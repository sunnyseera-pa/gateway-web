...
describe('<SVGIcon /> rendering', () => {
    it('renders all icons without crashing', () => {  
        ["dataseticon","projecticon","newnotificationicon","searchicon","toolicon","emptystar","clear","stock","default",
        "newprojecticon","newtoolicon","accounticon","dataaccessicon","rolesicon","bell","newestprojecticon",
        "personicon","closeicon","reviewsicon"].forEach((icon) => {
