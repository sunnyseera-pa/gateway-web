...
describe('<AddEditPaperForm /> rendering', () => {
    it('renders without crashing', () => { 
        wrapper = shallow(<AddEditPaperForm userState={userStateData.userState} data={preprintFormData.data} combinedUsers={preprintFormData.combinedUsers} relatedObjects={preprintFormData.relatedObjects}/>);   
    });
    ...
    it('will render with an "Update" button', () => {
        wrapper = shallow(<AddEditPaperForm isEdit={true} userState={userStateData.userState} data={preprintFormData.data} combinedUsers={preprintFormData.combinedUsers} relatedObjects={preprintFormData.relatedObjects}/>);
        expect(wrapper.find('[data-testid="updatePublishButton"]').text().trim()).toEqual('Update');
    });

    it('will render with a "Publish" button', () => {
        wrapper = shallow(<AddEditPaperForm isEdit={false} userState={userStateData.userState} data={preprintFormData.data} combinedUsers={preprintFormData.combinedUsers} relatedObjects={preprintFormData.relatedObjects}/>);
